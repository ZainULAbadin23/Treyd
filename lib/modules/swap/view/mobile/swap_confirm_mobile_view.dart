...
class SwapConfirmMobileView extends StatelessWidget {
  const SwapConfirmMobileView({super.key});
                ...
                Center(
                  ...
                  ontap: () {
                    ...
                    addNewVehicleBottomSheet(Get.context!, () {
                      Get.offAllNamed(Routes.SWAP_CONFIRM);
                    });
                  },
                )),
              ],
...
Widget _buildTransactionFields(SwapController controller) {
  return Column(
    crossAxisAlignment: CrossAxisAlignment.center,
    children: [
      Align(
