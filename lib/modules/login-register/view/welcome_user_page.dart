...
import 'package:treyd_crypto/modules/login-register/view/mobile/welcome_user_mobile_view.dart';

class WelcomeUserPage extends StatelessWidget {
  WelcomeUserPage({super.key});
    ...
    return Scaffold(
      ...
      body: SizedBox(
        ...
        child: ResponsiveWidget(
          smallScreen: WelcomeUserMobileView(),
        ),
      ),
    );
  }
