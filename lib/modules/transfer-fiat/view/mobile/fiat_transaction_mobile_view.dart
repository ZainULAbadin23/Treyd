...
class FiatTransactionMobileView extends StatelessWidget {
  const FiatTransactionMobileView({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<FiatTransactionController>(
      init: FiatTransactionController(),
      builder: (controller) {
